...
public class RequestTask implements Runnable {
    ...
    private final RemotingMessage request;
    private boolean stopRun = false;

    public RequestTask(final Runnable runnable, final Channel channel, final RemotingMessage request) {
    ...
    public void returnResponse(int code, String remark) {
        final RemotingMessage response = RemotingMessage.createRequestMessage(code);
